...
class MinIMU_v5_pi:
    ...
    def enableMag(self, mFullScale):
        ...
        self.bus.write_byte_data(self.mag, self.Mag_REG['CTRL_REG2'], self.binConcat([0, b1_2, 0, rebootMem, softReset, 0, 0]))
    ...
    def readAccelerometer(self):
        ...
        try:
            AX = self.byteToNumber(self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTX_L_XL']), self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTX_H_XL']))

            AY = self.byteToNumber(self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTY_L_XL']), self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTY_H_XL']))

            AZ = self.byteToNumber(self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTZ_L_XL']), self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTZ_H_XL']))
        except:
            # print "Error!"
            return 0, 0, 0
    ...
    def readGyro(self):
        ...
        # two's complement number to decimal.
        try:
            GX = self.byteToNumber(self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTX_L_G']), self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTX_H_G']))

            GY = self.byteToNumber(self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTY_L_G']), self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTY_H_G']))

            GZ = self.byteToNumber(self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTZ_L_G']), self.bus.read_byte_data(self.accel_gyro, self.Accel_Gyro_REG['OUTZ_H_G']))
        except:
            # print "Error!"
            return 0, 0, 0
    ...
    def readMagnetometer(self):
        ...
        # two's complement number to decimal.
        try:
            MX = self.byteToNumber(self.bus.read_byte_data(self.mag, self.Mag_REG['OUT_X_L']), self.bus.read_byte_data(self.mag, self.Mag_REG['OUT_X_H']))

            MY = self.byteToNumber(self.bus.read_byte_data(self.mag, self.Mag_REG['OUT_Y_L']), self.bus.read_byte_data(self.mag, self.Mag_REG['OUT_Y_H']))

            MZ = self.byteToNumber(self.bus.read_byte_data(self.mag, self.Mag_REG['OUT_Z_L']), self.bus.read_byte_data(self.mag, self.Mag_REG['OUT_Z_H']))
        except:
            # print "Error!"
            return 0, 0, 0
